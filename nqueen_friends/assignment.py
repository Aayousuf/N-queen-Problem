...
class Assignment(object):
    ...
    def addVariableToAssignment(self,var,value):
        ...
        #print("assing value ",var,self._valueOfVariable[var])
    def assigndomain(self):
        assigndomain=[]
        for var in self._valueOfVariable:
            assigndomain.append(self._valueOfVariable[var])
        return assigndomain
    
    def getassingvalue(self):
        return self._valueOfVariable
    ...
    def isSolution(self,csp):
        return self.isComplete(csp.getVariables()) and self.isConsistent(csp._constraints)
